...
- Minio Console
- Apache Hive Metastore standalone backed by
- PostgreSQL Database
- Iceberg Python Client
- DuckDB

This deployment uses a local stand alone Apache HIVE Metastore with an external PostgreSQL database for persistence.
